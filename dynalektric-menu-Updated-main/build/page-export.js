...
function PageExport({ navigate }) {
  ...
  ))))), /* @__PURE__ */ React.createElement("div", { className: "export-verify-actions" }, /* @__PURE__ */ React.createElement("button", { className: "btn btn-ghost on-dark", onClick: () => { exportTrack("clearance_scheme_view", { action: "view_address" }); navigate("contact", "map"); } }, "View Registered Address"), /* @__PURE__ */ React.createElement("button", { className: "btn btn-ghost on-dark", onClick: () => {
    exportTrack("supplier_qualification_click");
    navigate("contact");
